...
from mods.TurnCircular import turn_circular_10_sec, turn_circular_neg_60_sec
...
async def run(drone):
    ...
    try:
        ...
        await drone.offboard.set_attitude(Attitude(0.0, 3.0, 0.0, 1))
        await asyncio.sleep(5)


        print("10 saniye donus baslatiliyor...............")
        await turn_circular_10_sec()
        print("10 saniye donus bitti...............")
        print("60 saniye ters donus baslatiliyor...............")
        await turn_circular_neg_60_sec()
        print("60 saniye ters donus bitti...............")
